...
import { npm, NpmTabs } from '@app/mdx-scope';
export const npmStr = npm('npm', { package: 'shared-store-object' });
export const yarnStr = npm('yarn', { package: 'shared-store-object' });
export const pnpmStr = npm('pnpm', { package: 'shared-store-object' });
